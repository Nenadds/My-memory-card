...
question_list = []
question_list.append(Question('The national language of Brazil', 'Portuguese', 'Brazilian', 'Spanish', 'Italian'))
question_list.append(Question('Which color dose not appear on the American flag?', 'Green', 'Red', 'White', 'Blue'))
question_list.append(Question('A traditional residence of Yakut pepole', 'Urase', 'Yurt', 'Igloo', 'Hut'))
...
def check_answer():
    ...
    if answers[0].isChecked():
        ...
        print('Racing:' , (window.score / window.total * 100), '%')
    else:
...
def next_question():
    ...
    q = question_list[cur_question] # take a question
    ask(q)
